 ...
 *
 */
package com.osfglobal.hybris.emarsys.test.setup;
...
import com.osfglobal.hybris.emarsys.test.constants.OsfglobalhybrisemarsysTestConstants;
import com.osfglobal.hybris.emarsys.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = OsfglobalhybrisemarsysTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/osfglobalhybrisemarsystest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/osfglobalhybrisemarsystest/import/reviews.impex");
			...
			importImpexFile(context, "/osfglobalhybrisemarsystest/import/cstickets.impex");
		}
	}
}
