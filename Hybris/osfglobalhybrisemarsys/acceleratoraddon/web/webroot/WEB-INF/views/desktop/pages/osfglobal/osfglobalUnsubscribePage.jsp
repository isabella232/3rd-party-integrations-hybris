...
<template:page pageTitle="${pageTitle}">
    ...
    <h1>Unsubscribe</h1>
    <p><b>If you do not want to receive the newsletter anymore, click on the<br/>
    unsubscribe button below.</b><br/>
    <br/>
    <form:form action="" method="post">
        <div class="form-actions clearfix">
            <button type="submit" class="positive">Unsubscribe</button>
        </div>
    </form:form>
