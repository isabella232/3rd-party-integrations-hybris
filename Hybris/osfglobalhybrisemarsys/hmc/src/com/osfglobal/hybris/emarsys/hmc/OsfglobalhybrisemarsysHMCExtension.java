 ...
 *
 */
package com.osfglobal.hybris.emarsys.hmc;
...
/**
 * Provides necessary meta information about the osfglobalhybrisemarsys hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.3
 */
public class OsfglobalhybrisemarsysHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OsfglobalhybrisemarsysHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.osfglobal.hybris.emarsys.hmc.locales";
