...
/**
 * This is the extension manager of the Osfglobalhybrisemarsys extension.
 */
public class EmarsysManager extends GeneratedEmarsysManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmarsysManager.class.getName());
	 ...
	 */
	public static EmarsysManager getInstance()
	{
		return (EmarsysManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmarsysConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmarsysManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OsfglobalhybrisemarsysManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OsfglobalhybrisemarsysManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OsfglobalhybrisemarsysManager called, current tenant: " + getTenant().getTenantID());
		}
	}
