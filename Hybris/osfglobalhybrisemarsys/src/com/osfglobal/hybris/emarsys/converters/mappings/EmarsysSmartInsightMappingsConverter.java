...
public class EmarsysSmartInsightMappingsConverter implements EmarsysMappingsConverter {
    @Override
    public Multimap<String, String> convert(BaseSiteModel site) {
        Multimap<String, String> resultMap = ArrayListMultimap.create();
        site.getEmarsysSmartInsight().getEmarsysSmartInsightMappings().forEach(entry ->
