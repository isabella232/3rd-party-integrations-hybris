...
/*
 * Creation: 5 oct. 2016 by 5  Imad Eddine BOUIHI
 *
 */
...
public class SearchCommandProvider extends AbstractCommandProvider
{
	...
	public String getLogic()
	{
		...
		if (baseSite.getEmarsysPredict() != null
				&& !EmarsysWidgetTypeEnum.DISABLED.equals(baseSite.getEmarsysPredict().getSearchPageRecomType()))
		{
			return baseSite.getEmarsysPredict().getSearchPageRecomType().getCode();
		}
		return null;
	}
