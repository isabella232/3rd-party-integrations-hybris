...
public class CartCommandProvider extends AbstractCommandProvider
{
	...
	public String getLogic()
	{
		...
		if (baseSite.getEmarsysPredict() != null
				&& !EmarsysWidgetTypeEnum.DISABLED.equals(baseSite.getEmarsysPredict().getCartPageRecomType()))
		{
			return baseSite.getEmarsysPredict().getCartPageRecomType().getCode();
		}
		return null;
	}
