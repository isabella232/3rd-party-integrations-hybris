 ...
 *
 */
package com.osfglobal.hybris.emarsys.fulfilmentprocess.test;
...
import com.osfglobal.hybris.emarsys.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from osfglobalhybrisemarsysfulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/osfglobalhybrisemarsysfulfilmentprocess/test/osfglobalhybrisemarsysfulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "osfglobalhybrisemarsysfulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "osfglobalhybrisemarsysfulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "osfglobalhybrisemarsysfulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/osfglobalhybrisemarsysfulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/osfglobalhybrisemarsysfulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = OsfglobalhybrisemarsysFulfilmentProcessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				OsfglobalhybrisemarsysFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				OsfglobalhybrisemarsysFulfilmentProcessConstants.ORDER_PROCESS_NAME);
