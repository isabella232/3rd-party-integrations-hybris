 ...
 *
 */
package com.osfglobal.hybris.emarsys.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(OsfglobalhybrisemarsysFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(OsfglobalhybrisemarsysFulfilmentProcessConstants.PARENT_PROCESS);
