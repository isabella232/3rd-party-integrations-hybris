 ...
 *
 */
package com.osfglobal.hybris.emarsys.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, OsfglobalhybrisemarsysFulfilmentProcessConstants.PARENT_PROCESS);
