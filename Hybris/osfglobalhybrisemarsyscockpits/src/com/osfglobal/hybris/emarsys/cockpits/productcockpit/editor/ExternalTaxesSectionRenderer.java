 ...
 *
 */
package com.osfglobal.hybris.emarsys.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("osfglobalhybrisemarsyscockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("osfglobalhybrisemarsyscockpits.product.externalTaxes"));
