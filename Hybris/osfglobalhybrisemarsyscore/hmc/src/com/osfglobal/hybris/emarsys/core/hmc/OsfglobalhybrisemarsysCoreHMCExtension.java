 ...
 *
 */
package com.osfglobal.hybris.emarsys.core.hmc;
...
/**
 * Provides necessary meta information about the osfglobalhybrisemarsyscore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class OsfglobalhybrisemarsysCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OsfglobalhybrisemarsysCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.osfglobal.hybris.emarsys.core.hmc.locales";
