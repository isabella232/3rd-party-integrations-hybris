...
<c:forEach items="${predictWidgetData.cart.entries}" var="cartEntry" varStatus="status">
     ...
     <c:if test="${ predictWidgetData.baseProductOnly and not empty cartEntry.product.baseProduct}">
         <c:set var="productCode" value="${cartEntry.product.baseProduct}"/>
    </c:if>
    {item: '${productCode}', price: ${cartEntry.roundedBasePrice}, quantity: ${cartEntry.quantity}}
